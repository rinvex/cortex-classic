(function (factory) {
    ...
    DataTable.ext.buttons.create = {
        ...
        action: (e, dt, button, config) => window.location = routes.route(window.Cortex.routePrefix + '.create'),
    };

    DataTable.ext.buttons.import = {
        className: 'buttons-import',
        text: (dt) => '<i class="fa fa-upload"></i> ' + dt.i18n('buttons.import', 'Import'),
        action: (e, dt, button, config) => window.location = routes.route(window.Cortex.routePrefix + '.import'),
    };
